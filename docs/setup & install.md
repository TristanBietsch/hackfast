...
| tool               | desc                          | download                                 | docs/setup                                    |
| ------------------ | ----------------------------- | ---------------------------------------- | --------------------------------------------- |
| aerospace          | Tiling window manager (macOS) | https://github.com/nikitabobko/AeroSpace | https://nikitabobko.github.io/AeroSpace/guide |
| brew               | macOS package manager         | https://brew.sh                          | https://docs.brew.sh                          |
| cluely             | Meeting assistant             | https://cluely.com                       | https://cluely.com/docs                       |
| flux               | Screen warmth night lighting  | https://justgetflux.com                  | https://justgetflux.com/faq.html              |
| ghostty            | GPU terminal emulator         | https://ghostty.org                      | https://ghostty.org/docs                      |
| karabiner-elements | Advanced keyboard remapper    | https://karabiner-elements.pqrs.org      | https://karabiner-elements.pqrs.org/docs      |
| mullvad            | Privacy-focused VPN service   | https://mullvad.net/en/download          | https://mullvad.net/en/help                   |
| obsidian           | Markdown notes                | https://obsidian.md                      | https://help.obsidian.md                      |
...
## TUIs
| tool         | desc                          | download                                 | docs/setup                                   | alias    |
| ------------ | ----------------------------- | ---------------------------------------- | -------------------------------------------- | -------- |
| bpytop       | Resource monitor dashboard    | https://github.com/aristocratos/bpytop   | https://github.com/aristocratos/bpytop#usage | top      |
...
| tmux         | Terminal multiplexer sessions | https://github.com/tmux/tmux             | https://github.com/tmux/tmux/wiki            | tmux     |
| w3m          | TUI browser                   | https://github.com/tats/w3m              | http://w3m.sourceforge.net/MANUAL            | web      |
| obsidian-cli | terminal based obisidian      | https://github.com/Yakitrak/obsidian-cli | https://github.com/Yakitrak/obsidian-cli     | obsidian |
